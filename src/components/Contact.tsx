      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-white p-8 rounded-lg shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full bg-rose hover:bg-rose/90"
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="space-y-6">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-rose-light/30 flex items-center justify-center mr-4">
              ...
              <div>
                ...
                <a href="#" className="text-rose hover:text-rose/80">linkedin.com/in/sanobia-sadaf</a>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-rose-light/30 flex items-center justify-center mr-4">
              ...
              <div>
                ...
                <a href="#" className="text-rose hover:text-rose/80">github.com/sanobia-sadaf</a>
              </div>
            </div>
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-full bg-rose-light/30 flex items-center justify-center mr-4">
              ...
              <div>
                ...
                <a href="mailto:contact@sanobiasadaf.com" className="text-rose hover:text-rose/80">contact@sanobiasadaf.com</a>
              </div>
            </div>
          </div>
